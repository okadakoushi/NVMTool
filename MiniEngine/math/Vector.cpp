...
void Vector3::TransformCoord(const Matrix& mat)
{
	...
	DirectX::XMMATRIX xmm = DirectX::XMLoadFloat4x4(&mat.mat);
	//頂点変換。
	DirectX::XMVECTOR xmvOut = DirectX::XMVector3TransformCoord(
		xmv,
		xmm
	);
	vec = { xmvOut.m128_f32[0], xmvOut.m128_f32[1], xmvOut.m128_f32[2] };
}
